  ...
  return (
    <div className='w-[21%] h-[100vh] overflow-y-auto bg-[#152259] pt-[26px] px-[28px] relative'>
      ...
      <div className='pt-[60px] pl-1 space-y-[12px]'>
         <Navlink ImgUrl={dashboardIcon} title={"Dashboard"} URL={'/dashboard'}/>
         ...
         <Navlink ImgUrl={settingsAndProfileIcon} title={"Settings and profile"} URL={'/settingsAndProfile'}/>
         <Navlink ImgUrl={examsIcon} title={"Exams"} URL={'/exams'}/>
         <div className='flex items-center'>
         <NavLink className={"flex items-center space-x-[16px] hover:bg-[#779fc0] rounded-md w-[222px] pt-[11px] pb-[12px] pl-[16px] mt-[40px] relative"} to={"/features"}>
